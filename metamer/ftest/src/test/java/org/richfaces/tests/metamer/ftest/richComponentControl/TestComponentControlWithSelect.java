 ...
 */
public class TestComponentControlWithSelect extends AbstractComponentControlTest {

    private static final String[] OPERATIONS = new String[]{ "setValue", "showPopup", "hidePopup" /* "getValue" */ };
    ...
    protected void handleOperation(String operation) {
        if ("setValue".equals(operation)) {
            ...
            assertEquals(select.advanced().getInput().getStringValue(), "Texas");
