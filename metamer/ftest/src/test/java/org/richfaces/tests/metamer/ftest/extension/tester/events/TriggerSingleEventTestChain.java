 ...
 */
public interface TriggerSingleEventTestChain extends BasicTestChain {
    ...
    public interface EventTesterOn {
         ...
         */
        TriggerSingleEventTestChain withCustomAction(Action customAction);
    ...
    public interface EventTesterBasicConfig extends BasicTestChain {
        ...
        /**
         * Default option. First trz to trigger the tested event with WebDriver§s actions, then, only if previsous step failed,
